...
const PasswordResetScreen = () => {
    ...
    const { loading, error, serverStatus, serverMessage } = useSelector((state) => state.user);

    const headingBR = useBreakpointValue({ base: 'xs', md: 'sm' });
    const boxBR = useBreakpointValue({ base: 'transparent', md: 'bg-surface' });

    useEffect(() => {
        if (serverStatus && serverMessage) {
            toast({
    ...
    }, [error, toast, serverMessage, serverStatus, dispatch]);
