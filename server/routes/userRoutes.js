...
const verifyEmail = asyncHandler(async (req, res) => {
    ...
    user.active = true;
    await user.save();
    res.json('Thank you for verifying your email. You can close this window now.');
});
...
const passwordResetRequest = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (user) {
            ...
            res.status(200).send('We have sent you a recover email to your email address');
        } else {
...
const googleLogin = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.status(404).send('Something went wrong registering google user!');
    }
});
